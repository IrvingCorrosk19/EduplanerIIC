...
namespace SchoolManager.Migrations
{
    ...
    [Migration("20260912160021_AddAttendanceSubjectId")]
    partial class AddAttendanceSubjectId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManager.Models.Attendance", b =>
                {
                    ...
                    b.HasIndex(new[] { "AcademicYearId" }, "IX_Attendance_AcademicYearId");

                    b.HasIndex(new[] { "Date", "TrimesterId" }, "IX_Attendance_Date_Trimester");

                    b.HasIndex(new[] { "StudentId", "SubjectId", "GroupId", "GradeId", "Date" }, "IX_Attendance_Student_Subject_Group_Grade_Date");

                    b.HasIndex(new[] { "StudentId", "TrimesterId" }, "IX_Attendance_Student_Trimester");

                    b.HasIndex(new[] { "SubjectId" }, "IX_Attendance_SubjectId");

                    b.HasIndex(new[] { "TrimesterId" }, "IX_Attendance_TrimesterId");
            ...
            modelBuilder.Entity("SchoolManager.Models.DisciplineReport", b =>
                {
                    ...
                    b.Property<string>("DisciplineActionsJson")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("SchoolManager.Models.EmailQueue", b =>
                {
                    ...
                    b.ToTable("email_queues", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolManager.Models.School", b =>
                {
                    ...
                    b.Property<string>("IdCardPolicy")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("SchoolManager.Models.SchoolIdCardSetting", b =>
                {
                    ...
                    b.Property<bool>("ShowSchoolPhone")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
            ...
            modelBuilder.Entity("SchoolManager.Models.SchoolScheduleConfiguration", b =>
                {
                    ...
                    b.Property<int>("RecessAfterAfternoonBlockNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2)
                        .HasColumnName("recess_after_afternoon_block_number");

                    b.Property<int>("RecessAfterMorningBlockNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(4)
                        .HasColumnName("recess_after_morning_block_number");

                    b.Property<int>("RecessDurationMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30)
            ...
            modelBuilder.Entity("SchoolManager.Models.StudentIdCard", b =>
                {
                    ...
                    b.HasIndex(new[] { "StudentId", "Status" }, "IX_student_id_cards_student_id_status");

                    b.ToTable("student_id_cards", (string)null);
                });

            modelBuilder.Entity("SchoolManager.Models.StudentPaymentAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CarnetStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<DateTime?>("CarnetStatusUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("carnet_status_updated_at");

                    b.Property<Guid?>("CarnetUpdatedByUserId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("PlatformAccessStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<DateTime?>("PlatformStatusUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("platform_status_updated_at");

                    b.Property<Guid?>("PlatformUpdatedByUserId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("student_payment_access_pkey");

                    b.HasIndex("CarnetUpdatedByUserId");

                    b.HasIndex("PlatformUpdatedByUserId");

                    b.HasIndex(new[] { "CarnetStatus", "SchoolId" }, "IX_student_payment_access_carnet_status_school_id");

                    b.HasIndex(new[] { "SchoolId" }, "IX_student_payment_access_school_id");

                    b.HasIndex(new[] { "StudentId" }, "IX_student_payment_access_student_id");

                    b.HasIndex(new[] { "StudentId", "SchoolId" }, "IX_student_payment_access_student_id_school_id")
                        .IsUnique();

                    b.ToTable("student_payment_access", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolManager.Models.TeacherWorkPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("teacher_work_plans_pkey");
                    ...
                    b.HasIndex("TeacherId", "AcademicYearId", "Trimester", "SubjectId", "GroupId")
                        .IsUnique()
                        .HasDatabaseName("ix_teacher_work_plans_teacher_year_trim_subj_group");

                    b.ToTable("teacher_work_plans", (string)null);
                });

            modelBuilder.Entity("SchoolManager.Models.TeacherWorkPlanDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AchievementIndicators")
                        .HasColumnType("text")
                        .HasColumnName("achievement_indicators");

                    b.Property<string>("AttitudinalContent")
                        .HasColumnType("text")
                        .HasColumnName("attitudinal_content");

                    b.Property<string>("BasicCompetencies")
                        .HasColumnType("text")
                        .HasColumnName("basic_competencies");

                    b.Property<string>("ConceptualContent")
                        .HasColumnType("text")
                        .HasColumnName("conceptual_content");

                    b.Property<int>("DisplayOrder")
                        .HasColumnType("integer")
                        .HasColumnName("display_order");

                    b.Property<string>("ProceduralContent")
                        .HasColumnType("text")
                        .HasColumnName("procedural_content");

                    b.Property<Guid>("TeacherWorkPlanId")
                        .HasColumnType("uuid")
                        .HasColumnName("teacher_work_plan_id");

                    b.Property<string>("Topic")
                        .HasColumnType("text")
                        .HasColumnName("topic");

                    b.Property<string>("WeeksRange")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("weeks_range");

                    b.HasKey("Id")
                        .HasName("teacher_work_plan_details_pkey");

                    b.HasIndex("TeacherWorkPlanId");

                    b.ToTable("teacher_work_plan_details", (string)null);
                });

            modelBuilder.Entity("SchoolManager.Models.TeacherWorkPlanReviewLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("teacher_work_plan_review_logs_pkey");

                    b.HasIndex("PerformedByUserId");

                    b.HasIndex("TeacherWorkPlanId");

                    b.ToTable("teacher_work_plan_review_logs", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolManager.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PasswordEmailSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("password_email_sent_at");

                    b.Property<string>("PasswordEmailStatus")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
            ...
            modelBuilder.Entity("SchoolManager.Models.Attendance", b =>
                {
                    ...
                    b.HasOne("SchoolManager.Models.Trimester", "Trimester")
                        .WithMany("Attendances")
                        .HasForeignKey("TrimesterId")
            ...
            modelBuilder.Entity("SchoolManager.Models.StudentPaymentAccess", b =>
                {
                    b.HasOne("SchoolManager.Models.User", "CarnetUpdatedByUser")
                        .WithMany()
                        .HasForeignKey("CarnetUpdatedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("student_payment_access_carnet_updated_by_fkey");

                    b.HasOne("SchoolManager.Models.User", "PlatformUpdatedByUser")
                        .WithMany()
                        .HasForeignKey("PlatformUpdatedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                    ...
                    b.Navigation("CarnetUpdatedByUser");

                    b.Navigation("PlatformUpdatedByUser");
            ...
            modelBuilder.Entity("SchoolManager.Models.TeacherWorkPlan", b =>
                {
                    b.HasOne("SchoolManager.Models.AcademicYear", "AcademicYear")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plans_academic_year_id_fkey");

                    b.HasOne("SchoolManager.Models.User", "ApprovedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("teacher_work_plans_approved_by_fkey");
                    ...
                    b.HasOne("SchoolManager.Models.GradeLevel", "GradeLevel")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plans_grade_level_id_fkey");
                    ...
                    b.HasOne("SchoolManager.Models.Group", "Group")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plans_group_id_fkey");

                    b.HasOne("SchoolManager.Models.User", "RejectedByUser")
                        .WithMany()
                        .HasForeignKey("RejectedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("teacher_work_plans_rejected_by_fkey");

                    b.HasOne("SchoolManager.Models.School", "School")
                        .WithMany()
                        .HasForeignKey("SchoolId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("teacher_work_plans_school_id_fkey");
                    ...
                    b.HasOne("SchoolManager.Models.Subject", "Subject")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plans_subject_id_fkey");
                    ...
                    b.HasOne("SchoolManager.Models.User", "Teacher")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plans_teacher_id_fkey");
            ...
            modelBuilder.Entity("SchoolManager.Models.TeacherWorkPlanDetail", b =>
                {
                    b.HasOne("SchoolManager.Models.TeacherWorkPlan", "TeacherWorkPlan")
                        .WithMany("Details")
                        .HasForeignKey("TeacherWorkPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plan_details_plan_id_fkey");

                    b.Navigation("TeacherWorkPlan");
                });

            modelBuilder.Entity("SchoolManager.Models.TeacherWorkPlanReviewLog", b =>
                {
                    b.HasOne("SchoolManager.Models.User", "PerformedByUser")
                        .WithMany()
                        .HasForeignKey("PerformedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plan_review_logs_user_fkey");
                    ...
                    b.HasOne("SchoolManager.Models.TeacherWorkPlan", "TeacherWorkPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("teacher_work_plan_review_logs_plan_id_fkey");
